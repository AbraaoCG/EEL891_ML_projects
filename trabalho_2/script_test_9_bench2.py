...
# Convert results to DataFrame and sort by RMSPE
results_df = pd.DataFrame(results)
results_df = results_df.sort_values(by='rmspe')
...
# #predictions_df.to_csv('predictions/ExtraTrees_tuned_predicted_prices_pca2_outliers1_custom1_outliers2_1e-5_9999e-4_filteredIds1.csv', index=False)
